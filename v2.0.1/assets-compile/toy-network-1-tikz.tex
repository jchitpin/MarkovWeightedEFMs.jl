\begin{tikzpicture}[%
  ...
  \node[%
    lnode,text=black,right=1.0cm of A1
  ] (A2) {Met.\\2};
  \node[%
    right=1.0cm of A2, lnode,text=black,yshift=1.32cm
  ] (A3) {Met.\\3};
  \node[%
    right=1.0cm of A2, lnode,text=black,yshift=-1.32cm
  ] (A4) {Met.\\4};
  \node[%
    right=1.0cm of A3, lnode,text=black,yshift=-1.32cm
  ] (A5) {Met.\\5};
  \node[%
    right=1.0cm of A5, lnode,text=black
  ] (A6) {Met.\\6};
  \node[%
    right=1.0cm of A5, yshift=1.32cm,lnode,text=black
  ] (A7) {Met.\\7};
